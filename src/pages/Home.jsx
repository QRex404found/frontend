...
export function Home() {
  ...
  // ----------------------------------------------------------
  //  📌 창 너비에 따른 스케일 적용 (390px 기준)
  // ----------------------------------------------------------
  useEffect(() => {
    const handleResize = () => {
      const baseWidth = 390;
      const scale = Math.min(window.innerWidth / baseWidth, 1); // 데스크탑 커짐 방지
  ...
  return (
    <div className="w-full">
      {/* 스케일 적용 루트 */}
      <div id="home-root" style={{ transformOrigin: "top center" }}>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center md:items-start gap-20 mb-20">
              ...
              <motion.div
                ...
                className="
                  ...
                  aspect-square
                  mx-auto md:mx-0 overflow-hidden
                "
              >
                <img
                  src={holdingQR}
