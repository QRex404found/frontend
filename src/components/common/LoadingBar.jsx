...
    // 👈 분석 시작 후 메시지를 '분석 진행 중입니다...'로 통일
    setStatusMessage('분석 진행 중입니다...'); 
...
          // 👈 PROCESSING 단계로 넘어가도 메시지를 변경하지 않음 (통일 유지)
          // setStatusMessage('거의 완료되었습니다. 잠시만 기다려주세요...'); <--- 제거
...
  React.useEffect(() => {
    // 컴포넌트 마운트 시 초기 메시지를 '분석 진행 중입니다...'로 변경
    setStatusMessage('분석 진행 중입니다...'); 
...
      <div className="mb-4">
        {/* 로딩 바: FAKING/PROCESSING 단계에서 progress 값에 따라 시각적으로 움직임 */}
...
        **{/* {stage === LOADING_STAGES.FAKING && `${progress}% `} <-- 이 부분이 제거되어 퍼센테이지가 표시되지 않습니다. */}**
